...
namespace StackCombo.Combos.PvE
{
	internal static class BRD
	{
		...
		internal class BRD_StraightShotUpgrade : CustomComboClass
		{
		...
		internal class BRD_IronJaws : CustomComboClass
		{
		...
		internal class BRD_IronJaws_Alternate : CustomComboClass
		{
		...
		internal class BRD_Apex : CustomComboClass
		{
		...
		internal class BRD_AoE_oGCD : CustomComboClass
		{
		...
		internal class BRD_AoE_SimpleMode : CustomComboClass
		{
						...
						if (LevelChecked(WanderersMinuet))
						{
							...
							if (canWeave)
							{
								...
								if (songWanderer)
								{
									...
									if (songTimerInSeconds <= 3 && balladReady)
									{
										return MagesBallad;
									}
								}
								...
								if (songMage)
								{
									...
									{
										return empyrealReady ? EmpyrealArrow : ArmysPaeon;
									}
								}
							}
		...
		internal class BRD_ST_oGCD : CustomComboClass
		{
		...
		internal class BRD_AoE_Combo : CustomComboClass
		{
		...
		internal class BRD_ST_SimpleMode : CustomComboClass
		{
		...
		internal class BRD_Buffs : CustomComboClass
		{
		...
		internal class BRD_OneButtonSongs : CustomComboClass
		{

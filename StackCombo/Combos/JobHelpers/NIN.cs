	...
	internal class NIN
	{
		internal class MudraCasting : PvE.NIN
		{
			...
			private static bool CanCast()
			{
				...
				return gcd == 0.5
|| CustomComboFunctions.GetRemainingCharges(Ten) != 0 ||
			...
			public MudraState CurrentMudra
			{
				...
				set
				{
					justResetMudra = value == MudraState.None;
		...
		internal class NINOpenerLogic : PvE.NIN
		{
			...
			{
				return CustomComboFunctions.GetRemainingCharges(Ten) >= 1
&& !CustomComboFunctions.IsOnCooldown(Mug)
&& !CustomComboFunctions.IsOnCooldown(TenChiJin)
&& !CustomComboFunctions.IsOnCooldown(PhantomKamaitachi)
&& !CustomComboFunctions.IsOnCooldown(Bunshin)
&& !CustomComboFunctions.IsOnCooldown(DreamWithinADream) && !CustomComboFunctions.IsOnCooldown(Kassatsu);
			}
			...
			private bool DoPrePullSteps(ref uint actionID, MudraCasting mudraState)
			{
				...
				if (CurrentState == OpenerState.PrePull)
				{
					...
					{
						_ = mudraState.CastHuton(ref actionID);
						PrePullStep = 1;
						return true;
					}

					if (CustomComboFunctions.WasLastAction(Huton) && PrePullStep == 1)
					{
						PrePullStep++;
					}
					...
					if (CustomComboFunctions.WasLastAction(Hide) && PrePullStep == 2)
					{
						PrePullStep++;
					}
					else if (PrePullStep == 2) { actionID = CustomComboFunctions.OriginalHook(Hide); }

					if (CustomComboFunctions.WasLastAction(Suiton) && PrePullStep == 3)
					{
						CurrentState = OpenerState.InOpener;
					}
					else if (PrePullStep == 3)
					{
			...
			private bool DoOpener(ref uint actionID, MudraCasting mudraState)
			{
				...
				if (CurrentState == OpenerState.InOpener)
				{
					...
					if (CustomComboFunctions.WasLastAction(Kassatsu) && OpenerStep == 1)
					{
						OpenerStep++;
					}
					else if (OpenerStep == 1)
					{
						actionID = CustomComboFunctions.OriginalHook(Kassatsu);
					}

					if (CustomComboFunctions.WasLastAction(SpinningEdge) && OpenerStep == 2)
					{
						OpenerStep++;
					}
					else if (OpenerStep == 2)
					{
						actionID = CustomComboFunctions.OriginalHook(SpinningEdge);
					}

					if (CustomComboFunctions.WasLastAction(GustSlash) && OpenerStep == 3)
					{
						OpenerStep++;
					}
					else if (OpenerStep == 3)
					{
						actionID = CustomComboFunctions.OriginalHook(GustSlash);
					}

					if (CustomComboFunctions.WasLastAction(Mug) && OpenerStep == 4)
					{
						OpenerStep++;
					}
					else if (OpenerStep == 4)
					{
						actionID = CustomComboFunctions.OriginalHook(Mug);
					}

					if (CustomComboFunctions.WasLastAction(Bunshin) && OpenerStep == 5)
					{
						OpenerStep++;
					}
					else if (OpenerStep == 5)
					{
						actionID = CustomComboFunctions.OriginalHook(Bunshin);
					}

					if (CustomComboFunctions.WasLastAction(PhantomKamaitachi) && OpenerStep == 6)
					{
						OpenerStep++;
					}
					else if (OpenerStep == 6)
					{
						actionID = CustomComboFunctions.OriginalHook(PhantomKamaitachi);
					}

					if (CustomComboFunctions.WasLastAction(TrickAttack) && OpenerStep == 7)
					{
						OpenerStep++;
					}
					else if (OpenerStep == 7 && inLateWeaveWindow)
					{
						actionID = CustomComboFunctions.OriginalHook(TrickAttack);
					}

					if (CustomComboFunctions.WasLastAction(AeolianEdge) && OpenerStep == 8)
					{
						OpenerStep++;
					}
					else if (OpenerStep == 8)
					{
						actionID = CustomComboFunctions.OriginalHook(AeolianEdge);
					}

					if (CustomComboFunctions.WasLastAction(DreamWithinADream) && OpenerStep == 9)
					{
						OpenerStep++;
					}
					else if (OpenerStep == 9)
					{
						actionID = CustomComboFunctions.OriginalHook(DreamWithinADream);
					}

					if (CustomComboFunctions.WasLastAction(HyoshoRanryu) && OpenerStep == 10)
					{
						OpenerStep++;
					}
					...
					if (CustomComboFunctions.WasLastAction(Raiton) && OpenerStep == 11)
					{
						OpenerStep++;
					}
					...
					if (CustomComboFunctions.WasLastAction(TenChiJin) && OpenerStep == 12)
					{
						OpenerStep++;
					}
					else if (OpenerStep == 12)
					{
						actionID = CustomComboFunctions.OriginalHook(TenChiJin);
					}

					if (CustomComboFunctions.WasLastAction(TCJFumaShurikenTen) && OpenerStep == 13)
					{
						OpenerStep++;
					}
					...
					if (CustomComboFunctions.WasLastAction(TCJRaiton) && OpenerStep == 14)
					{
						OpenerStep++;
					}
					...
					if (CustomComboFunctions.WasLastAction(TCJSuiton) && OpenerStep == 15)
					{
						OpenerStep++;
					}
					...
					if (CustomComboFunctions.WasLastAction(Meisui) && OpenerStep == 16)
					{
						OpenerStep++;
					}
					else if (OpenerStep == 16)
					{
						actionID = CustomComboFunctions.OriginalHook(Meisui);
					}

					if (CustomComboFunctions.WasLastAction(FleetingRaiju) && OpenerStep == 17)
					{
						OpenerStep++;
					}
					else if (OpenerStep == 17)
					{
						actionID = CustomComboFunctions.OriginalHook(FleetingRaiju);
					}

					if (CustomComboFunctions.WasLastAction(Bhavacakra) && OpenerStep == 18)
					{
						OpenerStep++;
					}
					else if (OpenerStep == 18)
					{
						actionID = CustomComboFunctions.OriginalHook(Bhavacakra);
					}

					if (CustomComboFunctions.WasLastAction(FleetingRaiju) && OpenerStep == 19)
					{
						OpenerStep++;
					}
					...
					if (CustomComboFunctions.WasLastAction(Bhavacakra) && OpenerStep == 20)
					{

...
namespace StackCombo
{
	public sealed partial class StackComboClass : IDalamudPlugin
	{
		private const string Command = "/sc";

		private readonly ConfigWindow ConfigWindow;
		internal static StackComboClass? P = null!;
		...
		public StackComboClass(IDalamudPluginInterface pluginInterface)
		{
			P = this;
				...
				case "list":
					{
						...
						if (filter == "set")
						{
							foreach (bool preset in Enum.GetValues<CustomComboPreset>()
								.Select(PresetStorage.IsEnabled))
							{

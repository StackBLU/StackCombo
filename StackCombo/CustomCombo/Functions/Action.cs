...
namespace StackCombo.ComboHelper.Functions
{
	internal abstract partial class CustomComboFunctions
	{
		...
		public static bool CanWeave(uint actionID, double weaveTime = 0.5)
		{
		...
		public static bool CanSpellWeave(uint actionID, double weaveTime = 0.5)
		{
			...
			return GetCooldown(actionID).CooldownRemaining > weaveTime && castTimeRemaining <= 0.5 && GetCooldown(actionID).CooldownRemaining - castTimeRemaining - weaveTime >= 0;
		}

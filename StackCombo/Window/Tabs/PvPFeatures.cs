...
namespace StackCombo.Window.Tabs
{
	internal class PvPFeatures : ConfigWindow
	{
		...
		internal static new void Draw()
		{
			...
			using ImRaii.IEndObject scrolling = ImRaii.Child("scrolling", new Vector2(ImGui.GetContentRegionAvail().X, ImGui.GetContentRegionAvail().Y), true);
			int i = 1;
			...
			else
			{
				...
				using ImRaii.IEndObject contents = ImRaii.Child("Contents", new Vector2(0));
